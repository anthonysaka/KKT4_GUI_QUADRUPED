...
def main(mode):
    ...
    carImg = pygame.image.load('spider-web.png')
    ...
    #message_display('mode autonomous')
    message_display('KKT_T4 Robot mode autonomous ')
...
def decide_3():
    ...
    print('Muestrame un marcador!!\n\n')

    if status == 0 and Izquierda > Derecha and Izquierda > NoLinea:
    ...
    elif status == 0 and Derecha > Izquierda and Derecha > NoLinea:
    ...
    elif status == 1 and Izquierda > Derecha and Izquierda > NoLinea:
        ...
        if Izquierda > Derecha and Izquierda > NoLinea:
            ...
            for x in range(0, 5):
                forward()
            print('- MUESTRAME UN MARCADOR NUEVO!!')
        else:
            status = 1
            salute_1()  # Dice no

    elif status == 2 and Derecha > Izquierda and Derecha > NoLinea:
